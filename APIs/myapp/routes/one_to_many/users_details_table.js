...
router.post(
  "/insert-user",
  validation.validation_user_detail_table,
  users_detail.create
);
router.put(
  "/update-user/:id",
  validation_update.validation_user_detail_table,
  users_detail.update
);
router.delete("/delete-user-by-id/:id", users_detail.deleteByID);
router.delete(
  "/delete-user-by-address-id/:user_id/:id",
  users_detail.deleteByAddressID
);
