...
db.user_address = require("./one_to_one/user_address_model.js")(
  sequelize,
  Sequelize
);
...
db.user_table = require("./one_to_many/user_table_model.js")(
  sequelize,
  Sequelize
);
db.user_address_table = require("./one_to_many/user_address_table_model.js")(
  sequelize,
  Sequelize
);
...
db.actor_movie = require("./many_to_many/actor_movie_model.js")(
  sequelize,
  Sequelize
);

db.actor.belongsToMany(db.movie, {
  through: db.actor_movie,
  foreignKey: "actor_id",
});
